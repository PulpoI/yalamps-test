...
import { poppins, redHatDisplay } from "@/lib/fonts/index";
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head />
      <body
        className={cn("min-h-screen antialiased", poppins.variable, redHatDisplay.variable)}
      >
        <ThemeProvider
          attribute="class"
          defaultTheme="system"
...
const Nav = ({ className, children, id }: NavProps) => {
  return (
    <nav
      className={cn(
        "sticky z-50 top-0 bg-transparent h-0",
        "fade-in",
        className,
      )}
      id={id}
